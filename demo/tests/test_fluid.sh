...
../../atomorph -f test_${TITLE} -i ../data flowers.png merilin.png --blobs-as-texture --verbose -c 2 -p 3 -z 1 -M 10 -O 50 --blob-feather 256 --keep-background -F 96 -B 256 -L 10
...
montage test_${TITLE}_*.png -tile 3x4 -geometry 256x256+1+1 -frame 3 -background white -bordercolor white montage_${TITLE}.png
rm test_${TITLE}_*.png
